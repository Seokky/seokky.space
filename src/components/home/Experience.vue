    ...
    <ul class="experience__list">
      ...
      <li class="experience__item">
        ...
        <span class="experience__value">
          ...
          пишем много сложных форм и валидируем их.
        </span>
      </li>
      ...
      <li class="experience__item">
        <span class="experience__label">* Timeweb как первая крупная компания</span>
        <span class="experience__value">
          Принимаем активное участие в кое-каком проекте топ-3 хостинга Российского
          сегмента интернета. Продвигаем культуру кода и строгую типизацию.
        </span>
      </li>
    </ul>
  </section>
